    ...
    d3.csv("clean_dataset.csv").then(function(dataset){
        ...
        var countries=svg.append("g")
                            ...
                            .style("fill",d=>{
                                ...
                                return colorScale(popPerCountry[d.properties.NAME_LONG])
                            ...
                            .on("click", function(d, i){
                                ...
                                content_type(countryname[d.properties.NAME_LONG])
                                document.getElementById("violin").innerHTML=""
                                content_violin(countryname[d.properties.NAME_LONG],'')
                                document.getElementById("rating").innerHTML=""
                                content_rating(countryname[d.properties.NAME_LONG],'')
                                document.getElementById("details").innerHTML="Country: "+countryname[d.properties.NAME_LONG]+","+"releases: "+popPerCountry[d.properties.NAME_LONG]
                            })
